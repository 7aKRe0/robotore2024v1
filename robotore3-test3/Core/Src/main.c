...
float side_r_flag = 0, side_l_flag = 0;
float side_l_time = 0;
float side_r_time = 0;
float stop_flag = 0;
...
float Line3_sens[2];
float adjusted_speed_L = 0;
float adjusted_speed_R = 0;
float Line1_sens1 = 0, Line1_sens2 = 0, Line1_sens3 = 0, Line1_sens4 = 0;
float Line2_sens1 = 0, Line2_sens2 = 0, Line2_sens3 = 0, Line2_sens4 = 0;
int mode = 0;
int mode_processed = 0;
int tape_list[1000];
int section_index = 0;
uint32_t last_tape_time = 0;
uint32_t current_time = 0, current_ftime = 0, current_2ftime = 0;
...
int _write(int file, char *ptr, int len) {
 ...
 {
     uint32_t period = 1000000 / frequency / 2;  // 半周期�???????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��時間 (マイクロ??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?)
     uint32_t on_time = period * volume;  // volume??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?0.0から1.0の??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?囲で??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��???????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?
     uint32_t off_time = period - on_time;
     uint32_t start_time = HAL_GetTick();

     while ((HAL_GetTick() - start_time) < duration)
     {
         HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12, GPIO_PIN_SET);  // GPIOピンをHIGHに設??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?
         for(volatile int i = 0; i < on_time; i++);
         HAL_GPIO_WritePin(GPIOA, GPIO_PIN_12, GPIO_PIN_RESET);  // GPIOピンをLOWに設??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?
...
void handleButtonPress(void) {
   if (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_3) == GPIO_PIN_RESET) {
       HAL_Delay(200);
       while (HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_3) == GPIO_PIN_RESET);  // ボタンが離されるまで???????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��??????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?????��?��??��?��???��?��??��?��????��?��??��?��???��?��??��?��?つ
...
//     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_SET); // PHをHIGH(正転)左
...
//     HAL_GPIO_WritePin(GPIOA, GPIO_PIN_5, GPIO_PIN_RESET); // PHをHIGH(正転)
//     __HAL_TIM_SET_COMPARE(&htim2, TIM_CHANNEL_4, 800);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, MOT2PH_Pin|GPIO_PIN_11|GPIO_PIN_12, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MOT2PH_Pin PA11 PA12 */
  GPIO_InitStruct.Pin = MOT2PH_Pin|GPIO_PIN_11|GPIO_PIN_12;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
